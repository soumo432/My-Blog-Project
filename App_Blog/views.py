...
def searchblog(request):
    if request.method=='POST':
        ...
        blog = Blog.objects.filter(blog_title__contains = searched)
        return render(request, 'App_Blog/search_blog.html', {'searched': searched, 'blogs': blog})

    else:
        return render(request, 'App_Blog/search_blog.html', {})
